...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  updateLocation: (id, data) =>
    ipcRenderer.invoke("location:update", { id, data }),
  ...
  updateCamera: (id, data) =>
    ipcRenderer.invoke("cameras:update", { id, data }),
  ...
  updatePingInterval: (data) =>
    ipcRenderer.invoke("ping:updatePingIntervaldata", data),
  getCamerasAndNVRs: () => ipcRenderer.invoke("ping:getCamerasAndNVRsdata"),
  downloadNotWorkingCSV: (type) =>
    ipcRenderer.invoke("ping:downloadNotWorkingCSVdata", type),
