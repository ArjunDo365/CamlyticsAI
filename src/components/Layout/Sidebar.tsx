  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-900 h-full">
        ...
        {/* Logout Section */}
        <div className="absolute bottom-20 left-0 right-0 pb-2 pt-2 p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
          <button
